document.addEventListener('DOMContentLoaded', () => {
  ...
  const buttonMarkup = (label) => `
    <span class="copy-button-icon copy-icon" aria-hidden="true">${COPY_ICON}</span>
    <span class="copy-button-icon success-icon" aria-hidden="true">${SUCCESS_ICON}</span>
  ...
  document.querySelectorAll('pre').forEach((pre) => {
    ...
    button.innerHTML = buttonMarkup('Copy code to clipboard');
